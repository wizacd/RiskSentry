...
const STATUS_LEVEL: Record<RiskStatus, string> = { aman: "Level 1", waspada: "Level 3", bahaya: "Level 5" };
...
export default function RiskGaugeCard({
  ...
  const kelaikan = Math.round((100 - score) * 10) / 10;
    ...
    <div className="flex flex-col justify-between rounded-lg bg-white p-5 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] lg:col-span-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-lg font-bold text-[#191c1e]">Skor Kelaikan K3 Terpadu</p>
      ...
      <div className="my-2 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
        <RiskGauge value={kelaikan} max={100} color={color} />
